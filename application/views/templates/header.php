...
<head>
    ...
    <title>Forneris Blog, meu currículo!</title>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="57x57" href="<?= base_url("images/ico/apple-touch-icon-57-precomposed.png")?>">
            ...
            <div class="navbar navbar-fixed-top animated fadeInDown">
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand logo">
                        <a href="index.html"><img class="img-responsive" src="images/logo.png" alt="Image" ></a>
                    </div>
                </div>
                <div class="collapse navbar-collapse">
                    <nav id="mainmenu">
                        <ul class="nav navbar-nav">
                            <li class="scroll current"><a href="#home-banner">Inicio</a></li>
                            <li class="scroll"><a href="#about">Sobre mim</a></li>
                            <li class="scroll"><a href="#skill">Habilidades</a></li>
                            <li class="scroll"><a href="#exprience">Experiência</a></li>
                            <li class="scroll"><a href="#education">Educação</a></li>
